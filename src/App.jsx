...
//  Scrool Bar Style
  ...
  return (
    <>
    <UserContext.Provider value={{islogin,setislogin,closebtnlogin,setclosebtnlogin,usernamef,setusernamef,adminlogin,setadminlogin
    ,categery,setcategery,filterdata,setfilterdata}}>      {/*Context Values */}
