...
console.log(props.data.date);
  ...
  return (
    <div className='post'>
      ...
      <p id="Usernamef">{"/Posted By - @" + (props.data.usernamef? props.data.usernamef  :"admin")}</p>
      ...
      <div className='reaction'>
        <Reaction
          logo={<ThumbUpIcon style={{ fontSize: '1.8rem', padding: '10px',fontWeight:"800", color: hasUpvoted ? '#FF64B4' : 'white' }} />}
          reaction={votenum}
          onClick={upvote}
        />
        <Reaction
          logo={<ThumbDownIcon style={{ fontSize: '1.8rem', padding: '10px', color: hasDownvoted ? '7068F4' : 'white' }} />}
          onClick={downvote}
        />
        <Reaction
