...
export default function Write(props) {
 ...
 const forbiddenWords = [
  ...
  const forbiddenWordFound = forbiddenWords.some((word) => {
    return title.toLowerCase().includes(word) || contents.toLowerCase().includes(word);
  });
  ...
  if (forbiddenWordFound) {
    ...
    if (response.ok) {
      ...
      toast.success('"Thank you for submitting your post! Your contribution has been successfully submitted to Votely."')
    } else {
  ...
  return (
    <div className='write'>
      ...
      toastOptions={{
        ...
        duration: 4000,
        style: {
          backgroundImage: 'linear-gradient(to right, #9e99fd, #ff89c6, #ffe279)',
          color: 'black',
