...
export default function NestedList() {
  ...
  const { islogin, setislogin, closebtnlogin, setclosebtnlogin,usernamef,setusernamef,adminlogin,setadminlogin,categery,setcategery,filterdata,setfilterdata } =
  ...
  return (
    ...
    >
      ...
      <ListItemButton onClick={handleTvClick}>
        ...
        <ListItemText primary="Technology" sx={{ color: 'gray', bgcolor: 'black' }} />
      ...
      <Collapse in={tvOpen} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Biotechnology" sx={{ color: 'gray', bgcolor: 'black' }} />
          </ListItemButton>
          ...
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Drones" sx={{ color: 'gray', bgcolor: 'black' }} />
          </ListItemButton>
          ...
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Renewable Energy" sx={{ color: 'gray', bgcolor: 'black' }} />
          </ListItemButton>
          ...
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Nanotechnology" sx={{ color: 'gray', bgcolor: 'black' }} />
          </ListItemButton>
        </List>
      </Collapse>
      ...
      <ListItemButton onClick={handleCelebritiesClick}>
        ...
        <ListItemText primary="Politics" sx={{ color: 'gray', bgcolor: 'black' }} />
      ...
      <Collapse in={celebritiesOpen} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Democracy" sx={{ color: 'gray', bgcolor: 'black' }} />
          </ListItemButton>
          ...
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Elections" sx={{ color: 'gray', bgcolor: 'black' }} />
          </ListItemButton>
          ...
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Diplomacy" sx={{ color: 'gray', bgcolor: 'black' }} />
          </ListItemButton>
          ...
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Human rights" sx={{ color: 'gray', bgcolor: 'black' }} />
          </ListItemButton>
        </List>
      </Collapse>
    </List>
