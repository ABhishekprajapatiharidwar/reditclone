      ...
      >
        ...
        <MenuItem orientation="vertical" onClick={handleClose}
         sx={{ gridColumn: '1 / span 3' }}  >
          <ListItemDecorator  >
          <Avatar sx={{ backgroundImage:"linear-gradient(to right, #7068F4, #FF64B4, #FFD94A);"}}>{islogin ? usernamef.slice(0, 1)|| usernamelocally.slice(0,1): 'U'}</Avatar>
          </ListItemDecorator>
        ...
        <MenuItem orientation="vertical" onClick={handleClose}>
          <ListItemDecorator onClick={()=>{return (<Login/>)}}>
            <Avatar>L</Avatar>
          </ListItemDecorator>
          Login
        </MenuItem>
