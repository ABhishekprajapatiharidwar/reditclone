  ...
  return (
    <>
      <div className="postarea">
        {" "}
        {/*If login Show Create New Post Area*/}
        {islogin && <Write fun={getwrite} />}
        {/*All New Posts */}
        {categery
          ? false
          : allpost.map((data) => <Post key={data.id} data={data} />)}
        ...
        {categery
          ? false
          : jsonData.map((data) => <Post key={data.id} data={data} />)}
        {categery === "Home" && (
          <>
            {allpost.map((data) => (
              <Post key={data.id} data={data} />
