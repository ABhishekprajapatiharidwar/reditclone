...
export default function Signup(props) {
 ...
 async function Signupdata () {
    ...
    if(username==="admin"){
      toast.error("You can't choose the name 'admin' because it implies administrative access.");
    }
    
   else if (isuser) {
      const Isuser = Object.values(isuser);
      console.log(Isuser);
      const matchedUser = Isuser.find(
      ...
      const responsesignup = await fetch("https://redittclone-default-rtdb.firebaseio.com/users.json", {
        method: "POST",
        headers: {
